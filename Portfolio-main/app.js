...
const textLoad = () => {
    setTimeout(() => {
        text.textContent = "BE[CS] student";
    }, 0);
    setTimeout(() => {
...
downloadBtn.addEventListener("click", () => {
    let resumePath =
        "https://drive.google.com/drive/folders/19MbL5lvP7jt7c91Vkgq23ziIvXy6pCEL";
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "mohitepratik846@gmail.com", 
        Password: "DF82239F0C2FCAA5E0F664BA32B0C93325AA",
        To: "mohitepratik846@gmail.com",
        From: "mohitepratik846@gmail.com",
        Subject: sub.value,
        Body: bodyMesg,
    }).then((message) =>
